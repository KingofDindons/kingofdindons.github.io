(self["webpackChunkanimaux_attraper_duel_lite"] = self["webpackChunkanimaux_attraper_duel_lite"] || []).push([["src_app_home_home_module_ts"],{
...
/* harmony import */ var _app_picture_picture_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../app/picture/picture.service */ 4060);
/* harmony import */ var _auth_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../auth/auth.service */ 2176);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ 9535);
/* harmony import */ var _store_store_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store/store.service */ 6075);
...
let HomePage = class HomePage {
    constructor(pictureService, auth, router, store) {
...
HomePage.ctorParameters = () => [
    { type: _app_picture_picture_service__WEBPACK_IMPORTED_MODULE_2__.PictureService },
    { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_3__.AuthService },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__.Router },
    { type: _store_store_service__WEBPACK_IMPORTED_MODULE_4__.StoreService }
];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PictureService": () => (/* binding */ PictureService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 1855);
...
let PictureService = class PictureService {
    ...
    takeAndUploadPicture() {
        ...
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)((data) => this.uploadPicture(data.base64String)), 
        ...
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)((image) => console.log(`Successfully uploaded picture to ${image.url}`)));
    }
    /**
    ...
    takePicture() {
        ...
        const pictureDataPromise = _capacitor_camera__WEBPACK_IMPORTED_MODULE_0__.Camera.getPhoto(options);
        // Convert the promise to an observable and return it.
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)(pictureDataPromise);
    }
    /**
    ...
    uploadPicture(base64) {
        ...
        const requestOptions = {
            headers: {
                ...
                Authorization: `Bearer ${_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.qimgSecret}`,
            },
        };
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.qimgUrl}/images`, requestBody, requestOptions);
    }
};
PictureService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClient }
];
PictureService = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
